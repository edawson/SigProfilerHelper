...
def parse_args():
    ...
    parser.add_argument("-t", "--table", dest="table", help="Input mutational catalog table.", required=True)
    ...
    parser.add_argument("-g", "--genome-build",dest="genome", default="GRCh37", type=str)
    parser.add_argument("-s", "--start-process",dest="start", type=int, default=1)
    parser.add_argument("-e", "--end-process",dest="end", type=int, default=10)
...
if __name__ == "__main__":
    ...
    sig.sigProfilerExtractor("table", args.directory, args.table,
           startProcess=args.start, endProcess=args.end, totalIterations=args.iters,
           cpu=args.cpu, mtype=args.mtype, gpu=args.gpu)
